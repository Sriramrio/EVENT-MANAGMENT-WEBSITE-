...
import { useMeetingOutcomes } from '../../../../services/buyer/hooks';
import { ScreenShell } from '../shared/ScreenShell';
import { Card } from '../../../../components/ui/Card';
import { LoadingState, ErrorState } from '../../../../components/ui/PageStates';

export default function MeetingOutcomesPage() {
  const q = useMeetingOutcomes();
  ...
  return (
    <ScreenShell
      ...
      subtitle="Track decisions and next actions from completed meetings."
    >
      <div className="grid gap-4">
        {outcomes.length === 0 ? (
          ...
          outcomes.map((o: any) => {
            ...
            return (
              <Card key={o.meetingId} className="p-5">
                <div className="flex justify-between border-b pb-4 mb-4">
                  <div>
                    <h3 className="font-extrabold text-brand-700">{o.meetingNo}</h3>
