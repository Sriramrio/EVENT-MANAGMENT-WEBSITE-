...
export function VipVerificationPage() {
    ...
    const downloadBadge = async (
        ...
        try {
            ...
            const captureHeight = Math.max(element.scrollHeight, CARD_HEIGHT);
            ...
            const canvas = await html2canvas(element, {
                ...
                onclone: (clonedDocument) => {
                    ...
                    /*
                     * FORCE EXACT CARD SIZE WITH SAFETY HEIGHT
                     */
                    ...
                    clonedCard.style.minHeight = `${captureHeight}px`;
        ...
        <main className="min-h-screen bg-slate-100 px-4 py-8">
            ...
            <div className="flex flex-wrap items-start justify-center gap-8">
                ...
                <div
                    ...
                    className="relative box-border flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl w-full max-w-[350px]"
                    style={{
                ...
                >
                    ...
                    <div className="relative shrink-0 overflow-hidden bg-white px-5 pb-3.5 pt-6">
                        <div
                        ...
                        <div className="relative z-10 flex h-[50px] items-center justify-between gap-3">
                            {/* LUB */}

                            <div className="flex h-[46px] w-[80px] shrink-0 items-center justify-center rounded-lg bg-white/95">
                                <img
                                    src={brandAsset(
                                        'lub-logo.jpg'
                                    )}
                            ...
                            <div className="flex h-[46px] min-w-0 flex-1 items-center justify-end rounded-lg bg-white/95 px-1">
                                <img
                                    src={brandAsset(
                                    ...
                                    alt="MSME Connect"
                                    crossOrigin="anonymous"
                                    className="h-[45px] max-w-[170px] object-contain"
                                />
                            </div>
                        </div>
                        ...
                        <div className="relative z-10 mt-2.5">
                            <h3 className="text-[14px] font-black leading-tight tracking-tight text-slate-900">
                                LUB MSME Connect Expo 2026
                            </h3>

                            <p className="mt-0.5 text-[11px] font-extrabold text-orange-600">
                    ...
                    <div className="flex min-h-0 flex-1 flex-col items-center justify-center border-y border-slate-100 px-5 py-3.5 text-center">
                        {/* VIP */}

                        <span className="mb-1.5 rounded-full bg-orange-50 px-3 py-0.5 text-[10px] font-black uppercase tracking-[0.18em] text-orange-700">
                            VIP Delegate
                        </span>

                        {/* NAME */}

                        <h1 className="max-w-[300px] break-words text-[23px] font-black leading-[1.08] tracking-tight text-slate-900">
                            {vip.name}
                        </h1>
                        ...
                        {vip.designation && (
                            <p className="mt-1.5 max-w-[285px] break-words text-[13px] font-bold leading-tight text-slate-600">
                                {vip.designation}
                            </p>
                        )}
                        ...
                        {vip.organization && (
                            <p className="mt-1 max-w-[295px] break-words text-[15px] font-black leading-tight text-orange-700">
                                {vip.organization}
                            </p>
                        )}
                        ...
                        <div className="mt-3.5 rounded-xl border border-slate-200 bg-white p-2.5 shadow-sm">
                            <QRCode
                                value={pageQrUrl}
                                size={115}
                                level="M"
                    ...
                    <div className="shrink-0 bg-gradient-to-r from-red-600 to-orange-600 py-3 text-center">
                        <p className="mb-0.5 text-[8px] font-bold uppercase tracking-[0.2em] text-orange-100">
                            Official Delegate Pass
                        </p>

                        <h2 className="text-xl font-black uppercase leading-none tracking-[0.3em] text-white">
                            VIP
                        </h2>
                    </div>
                </div>
                ...
                >
                    ...
                    {/* =============================================
                        BACK HEADER
                    ============================================= */}
                    <div className="relative h-[60px] shrink-0 overflow-hidden bg-gradient-to-r from-red-600 via-orange-500 to-orange-500">
                        ...
                        />
                        <div
                            className="pointer-events-none absolute left-24 top-4 h-14 w-14 rotate-[-10deg] rounded-full bg-orange-200/40 blur-md"
                            aria-hidden="true"
                        />
                    </div>
                    ...
                    <div className="flex min-h-0 flex-1 flex-col justify-between overflow-hidden px-4.5 pb-2.5 pt-3 text-slate-700">
                        <div className="space-y-2.5">
                            ...
                            <div>
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-[12px] font-extrabold leading-none text-slate-900">
                                        Dates &amp; Timing
                                    </span>
                                </div>

                                <div className="mt-1 space-y-0.5 pl-5 text-[10.5px] font-semibold leading-tight text-slate-600">
                                    <p>
                                        18 September 2026 :
                            ...
                            <div>
                                ...
                                <p className="mt-1 pl-5 text-[10.5px] font-semibold leading-tight text-slate-600">
                            ...
                            <div>
                                ...
                                <p className="mt-1 pl-5 text-[10.5px] font-semibold leading-normal text-slate-600">
                            ...
                            <div className="border-t border-slate-100 pt-2">
                                <p className="mb-1.5 text-[10px] font-black uppercase tracking-[0.15em] text-orange-700">
                                    VIP Access
                                </p>
                                ...
                                <div className="space-y-1.5">
                                    <div className="flex items-start gap-1.5">
                                        ...
                                        <span className="text-[10.5px] font-semibold leading-tight text-slate-800">
                        ...
                        <div className="mt-2.5 flex items-end justify-between border-t border-slate-200 pt-2">
                            {/* LUB */}

                            <div className="flex min-w-0 items-center gap-2 pb-0.5">
                                <div className="flex h-9 w-14 shrink-0 items-center justify-center rounded-lg bg-white">
                                    <img
                                        src={brandAsset(
                                            'lub-logo.jpg'
                                        )}
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-0.5 text-[8.5px] font-medium leading-tight text-slate-500">
                                        Hosur MSME Conclave
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex shrink-0 flex-col items-center gap-1">
                                <span className="rounded-full bg-red-600 px-2 py-0.5 text-[7.5px] font-extrabold uppercase leading-none tracking-wider text-white">
                                    Venue Location
                                </span>

                                <div className="rounded-lg border border-slate-300 bg-white p-1 shadow-sm">
                                    <QRCode
                                        value={
                    ...
                    <div className="shrink-0 bg-gradient-to-r from-red-600 to-orange-600 px-4 py-2 text-center">
