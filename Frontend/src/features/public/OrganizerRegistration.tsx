        ...
        <main className="min-h-screen bg-slate-50 px-4 py-6">
            <form onSubmit={submit} className="mx-auto max-w-6xl rounded-3xl border border-slate-200 bg-white p-5 shadow-xl md:p-8">
                ...
                <div className="mt-6 rounded-3xl bg-msme-blue p-6 text-white">
                    ...
                    <h1 className="mt-2 text-3xl font-black">Organizer Registration Form</h1>
                ...
                <Section title="01. Organizer & Company Details">
                    <Field label="Company / Organizer Name" name="legalName" value={text('legalName')} onChange={set} required />
